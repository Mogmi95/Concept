...
def get_set():
    current_set = {
        ...
        73: {'image': 'part.png', 'description': ['Part', 'Bit', 'Piece']},
        74: {'image': 'inside.png', 'description': ['Inside', 'Internal']},
        75: {'image': 'grid.png', 'description': ['Grid', 'Network', 'Prison']},
        76: {'image': 'zero.png', 'description': ['Zero', 'Nothing', 'Null']},
        77: {'image': 'unity.png', 'description': ['Unity', 'One']},
        78: {'image': 'line.png', 'description': ['Straight line', 'Smooth', 'Rise']},
        79: {'image': 'curve.png', 'description': ['Curve', 'Arc', 'Rounded']},
        80: {'image': 'cross.png', 'description': ['Cross', 'Intersection', 'Addition']},
        81: {'image': 'brokenline.png', 'description': ['Broken line', 'Sharp', 'Uneven']},
        82: {'image': 'spiral.png', 'description': ['Spiral', 'Intoxication', 'Madness', 'Coil']},
        83: {'image': 'sinusoidal.png', 'description': ['Sinusoidal', 'Ripple', 'Hair']},
        84: {'image': 'ring.png', 'description': ['Ring', 'cycle']},
        85: {'image': 'circle.png', 'description': ['Circle', 'Button']},
        86: {'image': 'triangle.png', 'description': ['Triange']},
        87: {'image': 'star.png', 'description': ['Star']},
        88: {'image': 'rectangle.png', 'description': ['Rectangle', 'Square']},
        89: {'image': 'flat.png', 'description': ['Flat']},
        90: {'image': 'cube.png', 'description': ['Cube', 'Brick']},
        91: {'image': 'sphere.png', 'description': ['Sphere']},
        92: {'image': 'pyramid.png', 'description': ['Pyramid']},
        93: {'image': 'cylinder.png', 'description': ['Cylinder']},
        94: {'image': 'cone.png', 'description': ['Cone']},
        95: {'image': 'hollow.png', 'description': ['Hollow', 'Hole', 'Pierced']},
        96: {'image': 'tall.png', 'description': ['Tall', 'Greater', 'High']},
        97: {'image': 'small.png', 'description': ['Small', 'Lower', 'Below']},
        98: {'image': 'huge.png', 'description': ['Huge', 'Wider', 'Longer']},
        99: {'image': 'skinny.png', 'description': ['Skinny', 'Closer', 'Brief']},
        100: {'image': 'top.png', 'description': ['Top', 'Up', 'Mount']},
        101: {'image': 'low.png', 'description': ['Low', 'Down', 'Under']},
        102: {'image': 'left.png', 'description': ['Left', 'First', 'Before']},
        103: {'image': 'right.png', 'description': ['Right', 'End', 'After']},
        104: {'image': 'turn.png', 'description': ['Turn', 'Surround', 'Cycle']},
        105: {'image': 'use.png', 'description': ['Use', 'Activate', 'Verb']},
        106: {'image': 'red.png', 'description': ['Red']},
        107: {'image': 'orange.png', 'description': ['Orange']},
        108: {'image': 'yellow.png', 'description': ['Yellow']},
        109: {'image': 'green.png', 'description': ['Green']},
        110: {'image': 'blue.png', 'description': ['Blue']},
        111: {'image': 'purple.png', 'description': ['Purple']},
        112: {'image': 'pink.png', 'description': ['Pink']},
        113: {'image': 'brown.png', 'description': ['Brown']},
        114: {'image': 'black.png', 'description': ['Black']},
        115: {'image': 'gray.png', 'description': ['Gray']},
